...
public class RemoteEJBClient {
	...
	private static Account lookupAccountEJB() throws NamingException {
        ...
        jndiProperties.put(Context.INITIAL_CONTEXT_FACTORY, "org.wildfly.naming.client.WildFlyInitialContextFactory");
            ...
            jndiProperties.put(Context.PROVIDER_URL,"remote+http://eap-app-rasec.sandbox-dev.svc.cluster.local:8080");
...
/*
		...
		jndiProperties.put(Context.INITIAL_CONTEXT_FACTORY,  "org.wildfly.naming.client.WildFlyInitialContextFactory");
                jndiProperties.put(Context.PROVIDER_URL,"remote+http://eap-app-rasec.sandbox-dev.svc.cluster.local:8080");
                // Pure HTTP
		//jndiProperties.put(Context.PROVIDER_URL,"http://eap-app-rasec.sandbox-dev.svc.cluster.local:8080/wildfly-services");
